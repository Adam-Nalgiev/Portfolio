package com.pets.insplash.presentation.screen.home
...
import com.pets.insplash.domain.GetAuthStateUseCase
...
import com.pets.insplash.presentation.models.ImageDataModel
...
class HomeViewModel @Inject constructor(
    ...
    fun changeRecyclerData(requestText: String?) {
        photos = if (requestText == null) {
            ...
            Pager(
                ...
                initialKey = null,
                pagingSourceFactory = {
                    FoundPhotosPagingSource(
                        getFoundPhotosUseCase,
                        requestText
                    )
                }
            ).flow.cachedIn(viewModelScope)
    ...
    private suspend fun getPhoto(): OnePhoto? {
